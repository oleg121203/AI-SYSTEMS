#!/bin/bash
# Script to backup PostgreSQL data before recreating the volume
...
VOLUME_NAME="ai-systems_postgres_data"

echo -e "${BLUE}=== AI-SYSTEMS PostgreSQL Data Backup ===${NC}"
...
echo -e "${BLUE}=== AI-SYSTEMS PostgreSQL Data Backup Complete ===${NC}"
